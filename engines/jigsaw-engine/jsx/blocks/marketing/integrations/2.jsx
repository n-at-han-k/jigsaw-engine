...
const APPS = [
  {
    name: "Lovable",
    description:
      "An AI design assistant that helps you create interfaces and visuals with an intuitive and friendly approach.",
    logo: <Lovable />,
  },
  {
    name: "ChatGPT",
    description:
      "A conversational AI developed by OpenAI that can understand and generate human-like text across countless topics.",
    logo: <ChatGPT />,
  },
  {
    name: "Gemini",
    description:
      "Google's multimodal AI model designed to reason across text, images, code, and more.",
    logo: <Gemini />,
  },
  {
    name: "Grok",
    description:
      "An AI chatbot by xAI that provides witty, real-time insights integrated with X (formerly Twitter).",
    logo: <Grok />,
  },
  {
    name: "Claude",
    description:
      "An AI assistant by Anthropic focused on helpful, honest, and harmless conversations.",
    logo: <Claude />,
  },
  {
    name: "Kling AI",
    description:
      "A video-generation AI capable of creating realistic, dynamic scenes from text prompts.",
    logo: <KlingAI />,
  },
] as const;

export default function IntegrationsPartnerApps() {
  return (
      ...
      <div className="mx-auto max-w-6xl px-4">
        <header className="space-y-4 text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
            Browse our partner apps
          </h2>
          <p className="text-muted-foreground mx-auto max-w-xl text-base">
            Explore integrated apps that enhance productivity, streamline
            workflows, and simplify collaboration effortlessly.
          </p>
          <Button>Browse All Apps</Button>
        </header>

        <div className="mt-8 grid gap-2 sm:grid-cols-2 md:mt-12 lg:grid-cols-3">
          {APPS.map((app, i) => (
            <Card
              key={i}
              className="hover:bg-muted/70 bg-background overflow-hidden border-0 shadow-none transition-colors"
            >
              <CardContent className="flex h-full flex-col gap-4">
                <div className="shrink-0 *:size-10 [&_svg]:size-10">
                  {app.logo}
                </div>
