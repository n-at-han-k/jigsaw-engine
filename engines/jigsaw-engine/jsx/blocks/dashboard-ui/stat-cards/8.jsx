...
export default function Stats10() {
  return (
    <div className="bg-muted flex w-full items-center justify-center p-10">
      <dl className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {summary.map((item) => {
          ...
          return (
            <Card key={item.name} className="p-0 shadow-none">
              ...
              <div className="h-16 overflow-hidden">
                <ChartContainer
                  className="aspect-auto h-full w-full justify-start [&_.recharts-surface]:overflow-visible"
                  config={{
                    [item.name]: {
                      label: item.name,
                      color: color,
