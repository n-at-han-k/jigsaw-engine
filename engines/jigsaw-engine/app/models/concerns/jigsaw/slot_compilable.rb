module Jigsaw
  module SlotCompilable
    extend ActiveSupport::Concern

    included do
      acts_as_list scope: slot_list_scope

      validates :area_name, presence: true, uniqueness: { scope: slot_uniqueness_scope }
    ...
    private
      ...
      def set_default_sources
        return if respond_to?(:linked_to_template?) && linked_to_template?
