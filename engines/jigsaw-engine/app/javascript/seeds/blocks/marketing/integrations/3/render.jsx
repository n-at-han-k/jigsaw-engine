...
export default function IntegrationsLogosRow() {
  return (
    <section className="py-16">
      <div className="mx-auto max-w-4xl px-4 text-center">
        <h2 className="text-3xl leading-tight font-bold tracking-tight md:text-4xl">
          All types of integration for your team
        </h2>
        <p className="text-muted-foreground mt-4 text-base">
          Connect your favourites apps and service to enhance your experience
            ...
            {LOGOS.map((item, i) => (
              <Tooltip key={i}>
                <TooltipTrigger asChild>
                  <button
                    type="button"
                    className="focus-visible:ring-ring flex size-14 shrink-0 items-center justify-center overflow-hidden rounded-full border bg-background transition-transform hover:scale-110 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
                    style={{
                      marginLeft: i === 0 ? 0 : -12,
                    }}
                    aria-label={item.name}
                  >
                    <span className="[&_svg]:size-8">{item.logo}</span>
                  </button>
                </TooltipTrigger>
