      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
          <div className="max-w-xl space-y-4">
            <span className="inline-block rounded-full bg-blue-100 px-3 py-1 text-sm font-medium text-blue-600 dark:bg-blue-900 dark:text-blue-200">
              We&#39;re Hiring!
            </span>
            <h2 className="text-3xl leading-tight font-bold md:text-4xl">Let&#39;s Meet Our Team</h2>
